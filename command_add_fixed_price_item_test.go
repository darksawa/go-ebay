...
func Test_AddFixedPriceItem_CallName(t *testing.T) {
	s := AddFixedPriceItem{}

	assert.Equal(t, "AddFixedPriceItem", s.CallName())
}

func Test_AddFixedPriceItem_Body(t *testing.T) {
	s := AddFixedPriceItem{
		Currency:           "USD",
		Country:            "US",
		DispatchTimeMax:    1,
		...
		ListingType:        "type",
		Quantity:           1,
		BestOfferDetails:   &BestOfferDetails{true},
	...
	assert.Equal(t, "<Item><Currency>USD</Currency><Country>US</Country><DispatchTimeMax>1</DispatchTimeMax><ConditionID>1</ConditionID><Title>title</Title><Description>description</Description><StartPrice>1.02</StartPrice><ListingType>type</ListingType><Quantity>1</Quantity><BestOfferDetails><BestOfferEnabled>true</BestOfferEnabled></BestOfferDetails><PaymentMethods>paypal</PaymentMethods><PayPalEmailAddress>email</PayPalEmailAddress><ListingDuration>GTC</ListingDuration><ShippingDetails><ShippingType>type</ShippingType><ShippingDiscountProfileID>profile id</ShippingDiscountProfileID><InternationalShippingDiscountProfileID>i profile id</InternationalShippingDiscountProfileID><ShippingServiceOptions><ShippingService>service</ShippingService><ShippingServiceCost>1.23</ShippingServiceCost><ShippingServiceAdditionalCost>2.34</ShippingServiceAdditionalCost><FreeShipping>false</FreeShipping></ShippingServiceOptions><InternationalShippingServiceOption><ShippingService>service</ShippingService><ShippingServiceCost>1.23</ShippingServiceCost><ShippingServiceAdditionalCost>2.34</ShippingServiceAdditionalCost><ShipToLocation>ship</ShipToLocation><ShipToLocation>to</ShipToLocation><ShippingServicePriority>1</ShippingServicePriority></InternationalShippingServiceOption></ShippingDetails><PrimaryCategory><CategoryID>1</CategoryID></PrimaryCategory><Storefront><StoreCategoryID>categoryid</StoreCategoryID></Storefront><PostalCode>60657</PostalCode><ReturnPolicy><ReturnsAccepted>accepted</ReturnsAccepted><ReturnsAcceptedOption>accepted option</ReturnsAcceptedOption><ReturnsWithinOption>returns within option</ReturnsWithinOption><RefundOption>refund option</RefundOption><ShippingCostPaidByOption>shipping cost paid by option</ShippingCostPaidByOption></ReturnPolicy><PictureDetails><PictureURL>url</PictureURL></PictureDetails><ProductListingDetails><UPC>upc</UPC><BrandMPN><Brand>foo</Brand><MPN>bar</MPN></BrandMPN></ProductListingDetails><ItemSpecifics><NameValueList><Name>name</Name><Value>value</Value></NameValueList></ItemSpecifics></Item>", b.String())
}

func Test_AddFixedPriceItem_MissingFieldsBody(t *testing.T) {
	s := AddFixedPriceItem{
		Currency:        "USD",
		Country:         "US",
		StartPrice:      "1.23",
